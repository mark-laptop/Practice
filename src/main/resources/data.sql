INSERT INTO Address (id, version, name)
VALUES (1, 0, 'Ленина 47'),
       (2, 0, 'Толстого 2'),
       (3, 0, 'Советов 61'),
       (4, 0, 'Горького 3');
...
INSERT INTO Organization (id, version, name, full_name, inn, kpp, address_id, phone, is_active)
VALUES (1, 0, 'ООО Рога и копыта', 'Общество  с ограниченной ответственностью "Рога и копыта"', '123456789123',
        '123456789', 1, '89881231212', 1),
       (2, 0, 'ООО Ромашка', 'Общество  с ограниченной ответственностью "Ромашка"', '321987654321', '987654321', 3,
        '89613212121', 1);

INSERT INTO Office (id, version, organization_id, name, address_id, phone, is_active)
VALUES (1, 0, 1, 'Головной офис',       2, '82223333333', 1),
       (2, 0, 1, 'Дополнительный офис', 4, '83333223232', 1),
       (3, 0, 2, 'Головной офис',       3, '81232222222', 1);
